  ...
  return (
    <>
      ...
      <div className={styles.container}>
        ...
        <div className="p-4">
          <a>
            <Image src={Cans} alt="cans" width={1000} height={1000} />
          </a>
        </div>

        <div className="flex flex-col mt-[1em] w-[57%] gap-[5em]">
          <h1 className="flex justify-center font-bold text-[3em]">
            Package Design
          </h1>
          <p className="font-light text-[22px]">
            Evergreen Brewing is a brewery deeply inspired by the rich, earthy
            essence of the great outdoors. It strives to connect a fine drink
            with the beauty of nature. The design reflects this connection with
            a wood texture and a dark background that enhances the prominence of
            natural elements. The colors are carefully chosen to create harmony,
            ensuring that the visuals complement each other seamlessly.{" "}
          </p>
        </div>
        ...
        <div className=" flex flex-col p-4 gap-[3em] relative h-[310vh]">
          ...
          >
            ...
            <Image src={Cedar} alt="cedar" width={1000} height={1000} />
          </motion.div>
          <motion.div
            ref={pineRef}
          ...
          >
            <div className="flex mt-[10em]" />
            <Image src={Pine} alt="pine" width={1000} height={1000} />
          </motion.div>
          <motion.div
            ref={mapleRef}
          ...
          >
            <div className="flex mt-[10em]" />
            <Image src={Maple} alt="maple" width={1000} height={1000} />
          </motion.div>
        </div>
      </div>
    </>
